...
/**
 * Test case for class Todoweb\Theblog\Controller\PostController.
 *
...
class PostControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Todoweb\Theblog\Controller\PostController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Todoweb\\Theblog\\Controller\\PostController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllPostsFromRepositoryAndAssignsThemToView() {
		...
		$postRepository = $this->getMock('Todoweb\\Theblog\\Domain\\Repository\\PostRepository', array('findAll'), array(), '', FALSE);
