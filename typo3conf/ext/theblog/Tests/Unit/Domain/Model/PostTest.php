...
/**
 * Test case for class \Todoweb\Theblog\Domain\Model\Post.
 *
...
class PostTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Todoweb\Theblog\Domain\Model\Post
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Todoweb\Theblog\Domain\Model\Post();
	}
	...
	public function setCommentsForObjectStorageContainingCommentSetsComments() {
		$comment = new \Todoweb\Theblog\Domain\Model\Comment();
	...
	public function setAuthorForAuthorSetsAuthor() {
		$authorFixture = new \Todoweb\Theblog\Domain\Model\Author();
	...
	public function setTagsForObjectStorageContainingTagSetsTags() {
		$tag = new \Todoweb\Theblog\Domain\Model\Tag();
