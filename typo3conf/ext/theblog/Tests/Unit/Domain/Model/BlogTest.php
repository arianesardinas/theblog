...
/**
 * Test case for class \Todoweb\Theblog\Domain\Model\Blog.
 *
...
class BlogTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Todoweb\Theblog\Domain\Model\Blog
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Todoweb\Theblog\Domain\Model\Blog();
	}
	...
	public function setPostsForObjectStorageContainingPostSetsPosts() {
		$post = new \Todoweb\Theblog\Domain\Model\Post();
